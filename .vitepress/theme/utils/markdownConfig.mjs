...
const markdownConfig = (md, themeConfig) => {
  ...
  // mepay - 魔储MePay推广卡片
  md.use(container, "mepay", {
    render: (tokens, idx, _options) => {
      const token = tokens[idx];
      if (token.nesting === 1) {
        return `<div class="mepay-container">
          <div class="mepay-card">
            <div class="mepay-header">
              <img class="mepay-icon" src="/images/mepay/1cea2179-bde2-4364-b91f-3a0afae2d2c4.png" alt="魔儲" />
              <span class="mepay-title">魔儲 MePay</span>
              <span class="mepay-badge">推荐</span>
            </div>
            <div class="mepay-content">
              <p class="mepay-desc">氪金享 <strong>8%</strong> 回馈 · 注册时填写推荐码 <strong>WD</strong> 领50元券包</p>
              <p class="mepay-disclaimer">*本站不对其服务做出任何保证，使用前请了解相关条款</p>
              <p class="mepay-disclaimer">*50元券包实际为新台币200元，约等于人民币50元</p>
            </div>
            <div class="mepay-link">
              <a href="https://www.mepay.com.tw/auth?rcode=WD" target="_blank" rel="noopener noreferrer" class="mepay-btn" data-umami-event="MePay推广">
