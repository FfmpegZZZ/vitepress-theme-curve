        ...
        return `<div class="yunpan-container">
          <div class="yunpan-card">
            ...
            ${link ? `<div class="yunpan-link">
              <a href="${link}" target="_blank" rel="noopener noreferrer" class="yunpan-btn">
                <svg class="yunpan-download-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>
                </svg>
                立即下载
              </a>
              <button class="yunpan-copy-btn" onclick="navigator.clipboard.writeText('${link}').then(() => alert('链接已复制，关注无度谢谢喵~'))">
        ...
        return `<div class="offical-container">
          <div class="offical-card">
            ...
            ${link ? `<div class="offical-link">
              <a href="${link}" target="_blank" rel="noopener noreferrer" class="offical-btn">
              ...
              <button class="offical-copy-btn" onclick="navigator.clipboard.writeText('${link}').then(() => alert('官网链接已复制！'))">
